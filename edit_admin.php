									...
									<div class="form-body">
										...
										<form class="form-horizontal" method="post"> 
											...
											<div class="form-group"> 
												...
												<div class="col-sm-9"> 
												<input type="number" name="role" class="form-control" id="inputPassword3" placeholder="Role" value="<?php echo $urole; ?>"> 
												</div> 
											</div> 
										...
										$query = "UPDATE login SET NAME='$name', EMAIL='$email', PASSWORD='$pass', CONFIRM_PASSWORD='$cpass', CONTACT_NO='$cont', ADDRESS='$add', ROLE='$role' WHERE LOGIN_ID='$id'";
