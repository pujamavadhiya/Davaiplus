...
<!DOCTYPE html>
<head>
<title>Admin | Edit Instrument</title>
							...
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms"> 
									...
									<div class="form-body">
										<?php
										$id = $_GET['id'];
										$sql = "SELECT * FROM instruments WHERE INSTRUMENT_ID='$id'";
										$getresults = mysqli_query($con,$sql);
										while($viewdata = mysqli_fetch_array($getresults)){
										
										$uname = $viewdata['NAME'];
										$udes = $viewdata['DESCRIPTION'];
										...
										<form class="form-horizontal" method="post" enctype="multipart/form-data"> 
											...
											<div class="form-group"> 
												...
												<div class="col-sm-9"> 
												<!--<textarea rows=5  placeholder="description" name="des" value=""></textarea>-->
												<input type="text" name="des" class="form-control" placeholder="Name" value="<?php echo $udes; ?>"> 
												</div> 
											</div> 
										...
										$query = "UPDATE instruments SET NAME='$name', DESCRIPTION='$des', PRICE='$price', PHOTO='$image_path' WHERE INSTRUMENT_ID='$id'";
